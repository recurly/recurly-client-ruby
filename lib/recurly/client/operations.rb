...
module Recurly
  class Client
    ...
    # List sites
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_sites list_sites api documentation}
    #
    ...
    # Fetch a site
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_site get_site api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_accounts list_accounts api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    #   commas as separators, e.g. +ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6+.
    ...
    # Create an account
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_account create_account api documentation}
    #
    ...
    # Fetch an account
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_account get_account api documentation}
    #
    ...
    # Update an account
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/update_account update_account api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/deactivate_account deactivate_account api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_account_acquisition get_account_acquisition api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/update_account_acquisition update_account_acquisition api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/remove_account_acquisition remove_account_acquisition api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/reactivate_account reactivate_account api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_account_balance get_account_balance api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_billing_info get_billing_info api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/update_billing_info update_billing_info api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/remove_billing_info remove_billing_info api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/verify_billing_info verify_billing_info api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_billing_info create_billing_info api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param body [Requests::BillingInfoCreate] The Hash representing the JSON request to send to the server. It should conform to the schema of {Requests::BillingInfoCreate}
    # @param params [Hash] Optional query string parameters:
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_a_billing_info get_a_billing_info api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/update_a_billing_info update_a_billing_info api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param billing_info_id [String] Billing Info ID. Can ONLY be used for sites utilizing the Wallet feature.
    # @param body [Requests::BillingInfoCreate] The Hash representing the JSON request to send to the server. It should conform to the schema of {Requests::BillingInfoCreate}
    ...
    # Remove an account's billing information
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/remove_a_billing_info remove_a_billing_info api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param billing_info_id [String] Billing Info ID. Can ONLY be used for sites utilizing the Wallet feature.
    # @param params [Hash] Optional query string parameters:
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_account_coupon_redemptions list_account_coupon_redemptions api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_active_coupon_redemptions list_active_coupon_redemptions api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_coupon_redemption create_coupon_redemption api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/remove_coupon_redemption remove_coupon_redemption api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_account_credit_payments list_account_credit_payments api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #        :limit [Integer] Limit number of records 1-200.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_account_invoices list_account_invoices api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_invoice create_invoice api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/preview_invoice preview_invoice api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param body [Requests::InvoiceCreate] The Hash representing the JSON request to send to the server. It should conform to the schema of {Requests::InvoiceCreate}
    # @param params [Hash] Optional query string parameters:
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_account_line_items list_account_line_items api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_line_item create_line_item api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_account_notes list_account_notes api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_account_note get_account_note api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_shipping_addresses list_shipping_addresses api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_shipping_address create_shipping_address api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_shipping_address get_shipping_address api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/update_shipping_address update_shipping_address api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param shipping_address_id [String] Shipping Address ID.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/remove_shipping_address remove_shipping_address api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param shipping_address_id [String] Shipping Address ID.
    # @param params [Hash] Optional query string parameters:
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_account_subscriptions list_account_subscriptions api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_account_transactions list_account_transactions api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_child_accounts list_child_accounts api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_account_acquisition list_account_acquisition api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    #   commas as separators, e.g. +ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_coupons list_coupons api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    #   commas as separators, e.g. +ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6+.
    ...
    # Create a new coupon
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_coupon create_coupon api documentation}
    #
    ...
    # Fetch a coupon
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_coupon get_coupon api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/update_coupon update_coupon api documentation}
    #
    # @param coupon_id [String] Coupon ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-10off+.
    ...
    # Expire a coupon
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/deactivate_coupon deactivate_coupon api documentation}
    #
    # @param coupon_id [String] Coupon ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-10off+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/generate_unique_coupon_codes generate_unique_coupon_codes api documentation}
    #
    # @param coupon_id [String] Coupon ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-10off+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/restore_coupon restore_coupon api documentation}
    #
    # @param coupon_id [String] Coupon ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-10off+.
    # @param body [Requests::CouponUpdate] The Hash representing the JSON request to send to the server. It should conform to the schema of {Requests::CouponUpdate}
    # @param params [Hash] Optional query string parameters:
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_unique_coupon_codes list_unique_coupon_codes api documentation}
    #
    # @param coupon_id [String] Coupon ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-10off+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_credit_payments list_credit_payments api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :limit [Integer] Limit number of records 1-200.
    #        :order [String] Sort order.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_credit_payment get_credit_payment api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_custom_field_definitions list_custom_field_definitions api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    #   commas as separators, e.g. +ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_custom_field_definition get_custom_field_definition api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_invoice_template_accounts list_invoice_template_accounts api documentation}
    #
    ...
    # List a site's items
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_items list_items api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    #   commas as separators, e.g. +ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6+.
    ...
    # Create a new item
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_item create_item api documentation}
    #
    ...
    # Fetch an item
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_item get_item api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/update_item update_item api documentation}
    #
    # @param item_id [String] Item ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-red+.
    ...
    # Deactivate an item
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/deactivate_item deactivate_item api documentation}
    #
    # @param item_id [String] Item ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-red+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/reactivate_item reactivate_item api documentation}
    #
    # @param item_id [String] Item ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-red+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_measured_unit list_measured_unit api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    #   commas as separators, e.g. +ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_measured_unit create_measured_unit api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_measured_unit get_measured_unit api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/update_measured_unit update_measured_unit api documentation}
    #
    # @param measured_unit_id [String] Measured unit ID or name. For ID no prefix is used e.g. +e28zov4fw0v2+. For name use prefix +name-+, e.g. +name-Storage+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/remove_measured_unit remove_measured_unit api documentation}
    #
    # @param measured_unit_id [String] Measured unit ID or name. For ID no prefix is used e.g. +e28zov4fw0v2+. For name use prefix +name-+, e.g. +name-Storage+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_invoices list_invoices api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    #   commas as separators, e.g. +ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6+.
    ...
    # Fetch an invoice
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_invoice get_invoice api documentation}
    #
    ...
    # Update an invoice
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/update_invoice update_invoice api documentation}
    #
    # @param invoice_id [String] Invoice ID or number. For ID no prefix is used e.g. +e28zov4fw0v2+. For number use prefix +number-+, e.g. +number-1000+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_invoice_pdf get_invoice_pdf api documentation}
    #
    # @param invoice_id [String] Invoice ID or number. For ID no prefix is used e.g. +e28zov4fw0v2+. For number use prefix +number-+, e.g. +number-1000+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/collect_invoice collect_invoice api documentation}
    #
    # @param invoice_id [String] Invoice ID or number. For ID no prefix is used e.g. +e28zov4fw0v2+. For number use prefix +number-+, e.g. +number-1000+.
    # @param params [Hash] Optional query string parameters:
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/mark_invoice_failed mark_invoice_failed api documentation}
    #
    # @param invoice_id [String] Invoice ID or number. For ID no prefix is used e.g. +e28zov4fw0v2+. For number use prefix +number-+, e.g. +number-1000+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/mark_invoice_successful mark_invoice_successful api documentation}
    #
    # @param invoice_id [String] Invoice ID or number. For ID no prefix is used e.g. +e28zov4fw0v2+. For number use prefix +number-+, e.g. +number-1000+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/reopen_invoice reopen_invoice api documentation}
    #
    # @param invoice_id [String] Invoice ID or number. For ID no prefix is used e.g. +e28zov4fw0v2+. For number use prefix +number-+, e.g. +number-1000+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/void_invoice void_invoice api documentation}
    #
    # @param invoice_id [String] Invoice ID or number. For ID no prefix is used e.g. +e28zov4fw0v2+. For number use prefix +number-+, e.g. +number-1000+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/record_external_transaction record_external_transaction api documentation}
    #
    # @param invoice_id [String] Invoice ID or number. For ID no prefix is used e.g. +e28zov4fw0v2+. For number use prefix +number-+, e.g. +number-1000+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_invoice_line_items list_invoice_line_items api documentation}
    #
    # @param invoice_id [String] Invoice ID or number. For ID no prefix is used e.g. +e28zov4fw0v2+. For number use prefix +number-+, e.g. +number-1000+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_invoice_coupon_redemptions list_invoice_coupon_redemptions api documentation}
    #
    # @param invoice_id [String] Invoice ID or number. For ID no prefix is used e.g. +e28zov4fw0v2+. For number use prefix +number-+, e.g. +number-1000+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_related_invoices list_related_invoices api documentation}
    #
    # @param invoice_id [String] Invoice ID or number. For ID no prefix is used e.g. +e28zov4fw0v2+. For number use prefix +number-+, e.g. +number-1000+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    # Refund an invoice
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/refund_invoice refund_invoice api documentation}
    #
    # @param invoice_id [String] Invoice ID or number. For ID no prefix is used e.g. +e28zov4fw0v2+. For number use prefix +number-+, e.g. +number-1000+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_line_items list_line_items api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    #   commas as separators, e.g. +ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6+.
    ...
    # Fetch a line item
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_line_item get_line_item api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/remove_line_item remove_line_item api documentation}
    #
    # @param line_item_id [String] Line Item ID.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    # List a site's plans
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_plans list_plans api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    #   commas as separators, e.g. +ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6+.
    ...
    # Create a plan
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_plan create_plan api documentation}
    #
    ...
    # Fetch a plan
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_plan get_plan api documentation}
    #
    ...
    # Update a plan
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/update_plan update_plan api documentation}
    #
    # @param plan_id [String] Plan ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-gold+.
    ...
    # Remove a plan
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/remove_plan remove_plan api documentation}
    #
    # @param plan_id [String] Plan ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-gold+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_plan_add_ons list_plan_add_ons api documentation}
    #
    # @param plan_id [String] Plan ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-gold+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    # Create an add-on
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_plan_add_on create_plan_add_on api documentation}
    #
    # @param plan_id [String] Plan ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-gold+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_plan_add_on get_plan_add_on api documentation}
    #
    # @param plan_id [String] Plan ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-gold+.
    ...
    # Update an add-on
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/update_plan_add_on update_plan_add_on api documentation}
    #
    # @param plan_id [String] Plan ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-gold+.
    # @param add_on_id [String] Add-on ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-gold+.
    ...
    # Remove an add-on
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/remove_plan_add_on remove_plan_add_on api documentation}
    #
    # @param plan_id [String] Plan ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-gold+.
    # @param add_on_id [String] Add-on ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-gold+.
    # @param params [Hash] Optional query string parameters:
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_add_ons list_add_ons api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    #   commas as separators, e.g. +ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6+.
    ...
    # Fetch an add-on
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_add_on get_add_on api documentation}
    #
    # @param add_on_id [String] Add-on ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-gold+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_shipping_methods list_shipping_methods api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    #   commas as separators, e.g. +ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_shipping_method create_shipping_method api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_shipping_method get_shipping_method api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/update_shipping_method update_shipping_method api documentation}
    #
    # @param shipping_method_id [String] Shipping Method ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-usps_2-day+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/deactivate_shipping_method deactivate_shipping_method api documentation}
    #
    # @param shipping_method_id [String] Shipping Method ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-usps_2-day+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_subscriptions list_subscriptions api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    #   commas as separators, e.g. +ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_subscription create_subscription api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_subscription get_subscription api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/update_subscription update_subscription api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/terminate_subscription terminate_subscription api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    # @param params [Hash] Optional query string parameters:
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/cancel_subscription cancel_subscription api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    # @param params [Hash] Optional query string parameters:
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/reactivate_subscription reactivate_subscription api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    # Pause subscription
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/pause_subscription pause_subscription api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    ...
    # Resume subscription
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/resume_subscription resume_subscription api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/convert_trial convert_trial api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_preview_renewal get_preview_renewal api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_subscription_change get_subscription_change api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_subscription_change create_subscription_change api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/remove_subscription_change remove_subscription_change api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/preview_subscription_change preview_subscription_change api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    # @param body [Requests::SubscriptionChangeCreate] The Hash representing the JSON request to send to the server. It should conform to the schema of {Requests::SubscriptionChangeCreate}
    # @param params [Hash] Optional query string parameters:
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_subscription_invoices list_subscription_invoices api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_subscription_line_items list_subscription_line_items api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_subscription_coupon_redemptions list_subscription_coupon_redemptions api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_usage list_usage api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    # @param add_on_id [String] Add-on ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-gold+.
    # @param params [Hash] Optional query string parameters:
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_usage create_usage api documentation}
    #
    # @param subscription_id [String] Subscription ID or UUID. For ID no prefix is used e.g. +e28zov4fw0v2+. For UUID use prefix +uuid-+, e.g. +uuid-123457890+.
    # @param add_on_id [String] Add-on ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-gold+.
    ...
    # Get a usage record
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_usage get_usage api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/update_usage update_usage api documentation}
    #
    # @param usage_id [String] Usage Record ID.
    # @param body [Requests::UsageCreate] The Hash representing the JSON request to send to the server. It should conform to the schema of {Requests::UsageCreate}
    # @param params [Hash] Optional query string parameters:
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/remove_usage remove_usage api documentation}
    #
    # @param usage_id [String] Usage Record ID.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_transactions list_transactions api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :ids [String] Filter results by their IDs. Up to 200 IDs can be passed at once using
    #   commas as separators, e.g. +ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6+.
    ...
    # Fetch a transaction
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_transaction get_transaction api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_unique_coupon_code get_unique_coupon_code api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/deactivate_unique_coupon_code deactivate_unique_coupon_code api documentation}
    #
    # @param unique_coupon_code_id [String] Unique Coupon Code ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-abc-8dh2-def+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/reactivate_unique_coupon_code reactivate_unique_coupon_code api documentation}
    #
    # @param unique_coupon_code_id [String] Unique Coupon Code ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-abc-8dh2-def+.
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_purchase create_purchase api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/preview_purchase preview_purchase api documentation}
    #
    # @param body [Requests::PurchaseCreate] The Hash representing the JSON request to send to the server. It should conform to the schema of {Requests::PurchaseCreate}
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/create_pending_purchase create_pending_purchase api documentation}
    #
    # @param body [Requests::PurchaseCreate] The Hash representing the JSON request to send to the server. It should conform to the schema of {Requests::PurchaseCreate}
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_export_dates get_export_dates api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_export_files get_export_files api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_dunning_campaigns list_dunning_campaigns api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :sort [String] Sort field. You *really* only want to sort by +updated_at+ in ascending
    #   order. In descending order updated records will move behind the cursor and could
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_dunning_campaign get_dunning_campaign api documentation}
    #
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/list_invoice_templates list_invoice_templates api documentation}
    #
    # @param params [Hash] Optional query string parameters:
    #        :sort [String] Sort field. You *really* only want to sort by +updated_at+ in ascending
    #   order. In descending order updated records will move behind the cursor and could
    ...
    #
    # {https://developers.recurly.com/api/v2022-01-01#operation/get_invoice_template get_invoice_template api documentation}
    #
    # @param invoice_template_id [String] Invoice template ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param params [Hash] Optional query string parameters:
    #
