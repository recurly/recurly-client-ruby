...
module Recurly
  class Client
    ...
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param body [Requests::ExternalAccount] The Hash representing the JSON request to send to the server. It should conform to the schema of {Requests::ExternalAccount}
    # @param params [Hash] Optional query string parameters:
    #
    # @return [Resources::ExternalAccountResponse] A representation of the created external_account.
    #
    def create_account_external_account(account_id:, body:, **options)
      path = interpolate_path("/accounts/{account_id}/external_accounts", account_id: account_id)
      post(path, body, Requests::ExternalAccount, **options)
    end
    ...
    # @param params [Hash] Optional query string parameters:
    #
    # @return [Resources::ExternalAccountResponse] A external account on an account.
    #
    ...
    # @param params [Hash] Optional query string parameters:
    #
    # @return [Resources::ExternalAccountResponse] A representation of the updated external_account.
    #
    def update_account_external_account(account_id:, external_account_id:, body:, **options)
      path = interpolate_path("/accounts/{account_id}/external_accounts/{external_account_id}", account_id: account_id, external_account_id: external_account_id)
      put(path, body, Requests::ExternalAccount, **options)
    end

    # Delete an external account for an account
    #
    # {https://developers.recurly.com/api/v2021-02-25#operation/deleteAccountExternalAccount deleteAccountExternalAccount api documentation}
    #
    # @param account_id [String] Account ID or code. For ID no prefix is used e.g. +e28zov4fw0v2+. For code use prefix +code-+, e.g. +code-bob+.
    # @param external_account_id [String] External account ID, e.g. +s28zov4fw0cb+.
    # @param params [Hash] Optional query string parameters:
    #
    # @return [Resources::ExternalAccountResponse] Successful Delete
    #
    def deleteAccountExternalAccount(account_id:, external_account_id:, **options)
      path = interpolate_path("/accounts/{account_id}/external_accounts/{external_account_id}", account_id: account_id, external_account_id: external_account_id)
      delete(path, **options)
    end
