...
module Recurly
  module Resources
    class Account < Resource
      ...
      #   @return [Array[ExternalAccountResponse]] The external accounts belonging to this account
      define_attribute :external_accounts, Array, { :item_type => :ExternalAccountResponse }
