  ...
  describe "add-ons" do
    ...
    describe ".update_attributes" do
      ...
      it "will update subscription add-on tiers" do
        ...
        tiered_add_on.tiers.length.must_equal 2
      ...
      it 'will update subscription add-on percentage_tiers' do
        subscription.subscription_add_ons.length.must_equal 3
        tiered_percentage_add_on.tiers.length.must_equal 2

        subscription.update_attributes!(timeframe: "now")
        tiered_percentage_add_on.tiers.length.must_equal 3
        tiered_percentage_add_on.tiers[0].ending_amount_in_cents.must_equal 10000
        tiered_percentage_add_on.tiers[1].ending_amount_in_cents.must_equal 20000
      end
    end
  end
