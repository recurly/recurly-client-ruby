...
describe Webhook::ScheduledSubscriptionUpdateNotification do
  let(:notification) { Webhook::ScheduledSubscriptionUpdateNotification.from_xml(get_raw_xml 'webhooks/scheduled-subscription-update-notification.xml') }
