...
describe Webhook::NewChargeInvoiceNotification do
  let(:notification) { Webhook::NewChargeInvoiceNotification.from_xml(get_raw_xml 'webhooks/new-charge-invoice-notification.xml') }
