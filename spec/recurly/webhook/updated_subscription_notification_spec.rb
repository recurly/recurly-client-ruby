...
describe Webhook::UpdatedSubscriptionNotification do
  let(:notification) { Webhook::UpdatedSubscriptionNotification.from_xml(get_raw_xml 'webhooks/updated-subscription-notification.xml') }
