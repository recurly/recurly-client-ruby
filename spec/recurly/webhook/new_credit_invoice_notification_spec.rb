...
describe Webhook::NewCreditInvoiceNotification do
  let(:notification) { Webhook::NewCreditInvoiceNotification.from_xml(get_raw_xml 'webhooks/new-credit-invoice-notification.xml') }
