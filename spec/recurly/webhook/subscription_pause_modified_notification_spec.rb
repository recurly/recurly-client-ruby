...
describe Webhook::SubscriptionPauseModifiedNotification do
  let(:notification) { Webhook::SubscriptionPauseModifiedNotification.from_xml(get_raw_xml 'webhooks/subscription-pause-modified-notification.xml') }
