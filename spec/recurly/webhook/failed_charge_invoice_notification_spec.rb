...
describe Webhook::FailedChargeInvoiceNotification do
  let(:notification) { Webhook::FailedChargeInvoiceNotification.from_xml(get_raw_xml 'webhooks/failed-charge-invoice-notification.xml') }
