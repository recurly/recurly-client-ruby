...
describe Webhook::CanceledSubscriptionNotification do
  let(:notification) { Webhook::CanceledSubscriptionNotification.from_xml(get_raw_xml 'webhooks/canceled-subscription-notification.xml') }
