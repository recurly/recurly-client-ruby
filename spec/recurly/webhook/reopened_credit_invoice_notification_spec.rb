...
describe Webhook::ReopenedCreditInvoiceNotification do
  let(:notification) { Webhook::ReopenedCreditInvoiceNotification.from_xml(get_raw_xml 'webhooks/reopened-credit-invoice-notification.xml') }
