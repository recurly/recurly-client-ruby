...
describe Webhook::CanceledGiftCardNotification do
  let(:notification) { Webhook::CanceledGiftCardNotification.from_xml(get_raw_xml 'webhooks/canceled-gift-card-notification.xml') }
