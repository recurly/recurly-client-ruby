...
describe Webhook::PastDueChargeInvoiceNotification do
  let(:notification) { Webhook::PastDueChargeInvoiceNotification.from_xml(get_raw_xml 'webhooks/past-due-charge-invoice-notification.xml') }
