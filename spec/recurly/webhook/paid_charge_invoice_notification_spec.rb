...
describe Webhook::PaidChargeInvoiceNotification do
  let(:notification) { Webhook::PaidChargeInvoiceNotification.from_xml(get_raw_xml 'webhooks/paid-charge-invoice-notification.xml') }
