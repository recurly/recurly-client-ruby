...
describe Webhook::VoidPaymentNotification do
  let(:notification) { Webhook::VoidPaymentNotification.from_xml(get_raw_xml 'webhooks/void-payment-notification.xml') }
