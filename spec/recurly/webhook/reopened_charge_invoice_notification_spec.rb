...
describe Webhook::ReopenedChargeInvoiceNotification do
  let(:notification) { Webhook::ReopenedChargeInvoiceNotification.from_xml(get_raw_xml 'webhooks/reopened-charge-invoice-notification.xml') }
