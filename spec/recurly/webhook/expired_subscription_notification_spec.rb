...
describe Webhook::ExpiredSubscriptionNotification do
  let(:notification) { Webhook::ExpiredSubscriptionNotification.from_xml(get_raw_xml 'webhooks/expired-subscription-notification.xml') }
