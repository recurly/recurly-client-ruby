...
describe Webhook::ProcessingChargeInvoiceNotification do
  let(:notification) { Webhook::ProcessingChargeInvoiceNotification.from_xml(get_raw_xml 'webhooks/processing-charge-invoice-notification.xml') }
