...
describe Webhook::FailedPaymentNotification do
  let(:notification) { Webhook::FailedPaymentNotification.from_xml(get_raw_xml 'webhooks/failed-payment-notification.xml') }
